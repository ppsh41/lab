    ...
    <main class="container">
        ...
        <div class="btn-group countryButtons" role="group" aria-label="...">
			...
			foreach($countries as $i){
				echo "<a role='button' class='btn btn-default' href='list.php?conutry=$i'>$i</a>";
			}
		...
		foreach($images as $i){
			...
			echo "<li><a class='img-responsive' href='detail.php?id=$id'><img alt='$alt' src='images/square/$path'/><div class='caption'><div class='blur'></div><div class='caption-text'><h1>$alt</h1></div></div></a></li>";
		}
          /* you will need to fill this place with appropriate PHP */ 
          /* hint: use array and loop */
